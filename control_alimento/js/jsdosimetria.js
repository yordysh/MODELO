...
function exportardosimetria(obj) {
  ...
  $.each(obj["d"], function (i, l) {
    ...
    if (i % 2 == 0) {
      ...
      doc.line(52, 52, 52, 188); //tercera linea vertical
      doc.line(82, 52, 82, 188); // cuarta linea vertical
      doc.line(82, 57, 115, 57); //linea horizontal
      doc.line(98, 57, 98, 188); //quinta linea vertical
      doc.line(115, 52, 115, 194); //sexta linea vertical
      doc.line(137, 52, 137, 194); // ultima linea vertical

      doc.text("N°", 9.5, 58);
      doc.text("MATERIA PRIMA /", 20, 56);
      doc.text("INSUMO", 27, 60);
      doc.text("CÓDIGO/LOTE ", 56, 58);
      doc.text("PRESENTACIÓN", 86, 56);
      doc.text("g", 90, 60.5);
      doc.text("KG", 103, 60.5);
      doc.text("CANTIDAD", 118, 58);
      ...
      var che1X_1 = 103; // Posición X
      var che1Y_1 = 65; // Posición Y

      var che2X_1 = 89; // Posición X
    ...
    if (i % 2 != 0 || hojbla == 1) {
      ...
      doc.text("N°", 162.5, 58);
      doc.text("MATERIA PRIMA /", 173, 56);
      doc.text("INSUMO", 180, 60);
      doc.text("CÓDIGO/LOTE ", 209, 58);
      doc.text("PRESENTACIÓN", 239, 56);
      doc.text("g", 242, 60.5);
      doc.text("KG", 257, 60.5);
      doc.text("CANTIDAD", 270.5, 58);
      ...
      doc.line(205, 52, 205, 188); // tercera linea vertical
      doc.line(235, 52, 235, 188); // cuarta linea vertical
      doc.line(235, 57, 268, 57); //linea horizontal
      doc.line(251, 57, 251, 188); //quinta linea vertical
      doc.line(268, 52, 268, 194); //sexta linea vertical
      ...
      var che1X_2 = 257; // Posición X
      var che1Y_2 = 65; // Posición Y

      var che2X_2 = 242; // Posición X
      $.each(material, function (s, a) {
        ...
        doc.text("" + a[4], 270.5, altura2); //peso
