...
function exportardosimetria(obj) {
      ...
      $.each(obj['d'],function (i,l) {
         ...
         let lote = l[6];
         let material = l[8]
         if(can%2 == 0 && i == can) {hojbla = 1 ;}else{hojbla = 0}
         if(i%2 == 0 ){
            if(i != 0){doc.addPage();}
            limitleft = 6;
            var logo = new Image();
         ...
         if(i%2 != 0 || hojbla == 1){
            if(hojbla == 1){operario ='';cantidad='';bachada = '';fecha='';lote='';producto='';material=[]}
            doc.setFontSize(9)
            /*segunda columna*/
