...
$totalstock = $mostrar->MostrarStockActual();
    ...
    <header>
        <table>
            ...
            <tr>
                ...
                <td rowspan="2" style="text-align: center; font-size:15px; font-weight:200; width:400px;">LISTA DE STOCK ACTUAL - <?php echo $anio; ?></td>
                <td>Página:</td>
            </tr>
            <tr>
